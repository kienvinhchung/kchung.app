                                                ...
                                                return (
                                                        ...
                                                        >
                                                                ...
                                                                <div className="w-full flex justify-between items-center">
                                                                        ...
                                                                        >
                                                                                <BsArrowUpRight className="text-primary text-2xl" />
                                                                        </Link>
                                                                </div>

                                                                {/* title */}
                                                                <h2 
                                                                className="text-[32px] font-bold leading-none text-primarytext group-hover:text-accent transition-all duration-500">
                                                                        {service.title}
                                                                </h2>
